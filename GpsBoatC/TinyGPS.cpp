...
bool TinyGPS::term_complete()
{
    ...
    switch(COMBINE(_sentence_type, _term_number))
  {
    ...
    case COMBINE(_GPS_SENTENCE_GPRMC, 9): // Date (GPRMC)
      ...
      break;
    case COMBINE(_GPS_SENTENCE_GPRMC, 10): // Magnetic Var (GPRMC)
      _new_mag_var = parse_decimal();
      break;
    case COMBINE(_GPS_SENTENCE_GPRMC, 11): // Magnetic Var E/W (GPRMC)
      if (_term[0] == 'W')
        _new_mag_var = -_new_mag_var;
      break;
...
float TinyGPS::f_magnetic_var()
{
  return _mag_var == GPS_INVALID_MAG_VAR ? GPS_INVALID_MAG_VAR : _mag_var / 10.0;
}
...
const float TinyGPS::GPS_INVALID_F_MAG_VAR = 999.9;
